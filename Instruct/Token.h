...
enum TokenType {
	...
	TIMES_TOKEN, DIVIDE_TOKEN, PLUS_EQUAL_TOKEN, MINUS_EQUAL_TOKEN,
	// Other Characters:
	SEMICOLON_TOKEN, LPAREN_TOKEN, RPAREN_TOKEN, LCURLY_TOKEN,
	RCURLY_TOKEN,
	// Other Token Types:
	IDENTIFIER_TOKEN, INTEGER_TOKEN, ENDL_TOKEN, AND, OR,
	BAD_TOKEN, EOF_TOKEN
};
...
"NOTEQUAL", "INSERTION", "ASSIGNMENT", "PLUS", "MINUS", 
"TIMES", "DIVIDE", "PLUSEQUAL","MINUSEQUAL",
"SEMICOLON", "LPAREN", "RPAREN", "LCURLY", "RCURLY", 
"IDENTIFIER", "INTEGER", "ENDL", "AND", "OR", "BAD", "ENDFILE"
};
